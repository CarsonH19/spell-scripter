...
const quests = {
  ...
  liheth: [
    ...
    },
    {
      questNumber: 2,
      unlocked: false,
      name: "Rest for the Wandering",
      text: `"Wandering Wisps are lost souls trapped in eternal torment. We must guide them to their rest, freeing them from their endless wanderings."`,
      description: "Help put to rest Wandering Wisps.",
      progress: 0,
      completion: 1,
      finished: false,
    ...
    },
    {
      questNumber: 4,
      unlocked: false,
      name: "Desiccated Sanctuaries",
      text: `"Some shrines have fallen to desiccation and decay. We must cleanse these three shrines to renew their sanctity and restore their light."`,
      description: "Cleanse 3 desiccated shrines.",
      progress: 0,
      completion: 5,
      finished: false,
