...
const SPIDERS = {
  CRYPT_CRAWLER: {
    ...
    stats: {
      level: 1,
      health: STAT_RANKS.LOW,
      attack: STAT_RANKS.LOW,
      damageType: DAMAGE_TYPES.PHYSICAL,
      hitChance: STAT_RANKS.AVERAGE,
      critChance: STAT_RANKS.AVERAGE,
      defense: STAT_RANKS.LOW,
      speed: STAT_RANKS.HIGH,
      weaknesses: [],
      resistances: [],
      immunities: [CONDITIONS.WEBBED],
    },
    soundEffects: {},
  ...
  BROODMOTHER: {
    ...
    stats: {
      level: 4,
      health: STAT_RANKS.AVERAGE,
      attack: STAT_RANKS.AVERAGE,
      damageType: DAMAGE_TYPES.PHYSICAL,
      hitChance: STAT_RANKS.AVERAGE,
      critChance: STAT_RANKS.AVERAGE,
      defense: STAT_RANKS.LOW,
      speed: STAT_RANKS.AVERAGE,
      weaknesses: [],
      resistances: [],
      immunities: [CONDITIONS.WEBBED],
    },
...
const CULTISTS = {
  CULTIST: {
    ...
    stats: {
      ...
      health: STAT_RANKS.LOW,
      attack: STAT_RANKS.LOW,
      damageType: DAMAGE_TYPES.LOW,
      hitChance: STAT_RANKS.LOW,
      critChance: STAT_RANKS.LOW,
      defense: STAT_RANKS.LOW,
      speed: STAT_RANKS.AVERAGE,
      weaknesses: [],
      resistances: [],
  ...
  CRYPT_FIEND: {
    ...
    stats: {
      level: 7,
      health: STAT_RANKS.HIGH,
      attack: STAT_RANKS.AVERAGE,
      damageType: DAMAGE_TYPES.PHYSICAL,
      hitChance: STAT_RANKS.AVERAGE,
      critChance: STAT_RANKS.AVERAGE,
      defense: STAT_RANKS.AVERAGE,
      speed: STAT_RANKS.AVERAGE,
      weaknesses: [],
      resistances: [DAMAGE_TYPES.FIRE, DAMAGE_TYPES.POISON],
